...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run DDPG benchmark on Pendulum-v1")
    ...
    parser.add_argument("--video-dir", default="videos/ddpg", help="Directory for recorded videos")
...
if __name__ == "__main__":
    ...
    _, result = run_timed(lambda: run_ddpg(config), "DDPG")
    print("\n--- Summary ---")

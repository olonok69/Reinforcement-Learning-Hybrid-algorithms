...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run SAC benchmark on Pendulum-v1")
    ...
    parser.add_argument("--video-dir", default="videos/sac", help="Directory for recorded videos")
...
if __name__ == "__main__":
    ...
    _, result = run_timed(lambda: run_sac(config), "SAC")
    print("\n--- Summary ---")
